<template>
  <main v-cloak>
    <div
      v-if="loading"
      class="loading-spinner flex justify-center items-center text-5xl text-center bg-[#2F3C52] text-[#B6B6B6]"
      style="width: 100vw; height: 100vh; font-family: Arial, Helvetica, sans-serif"
    >
      <div>
        <span
          v-for="(char, i) in loadingText"
          :key="i"
...
.loading-letter {
  display: inline-block;
  animation: breathe 0.5s infinite ease-in-out;
